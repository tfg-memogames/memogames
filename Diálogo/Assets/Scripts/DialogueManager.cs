...
public class DialogueManager : MonoBehaviour {
    ...
    [SerializeField]
    private FirstPersonController _playerC;
    ...
    void Start () {
        ...
        _playerC = GameObject.FindObjectOfType<FirstPersonController>();
        hideDialogue();
        //showDialogue();
	...
	void Update () {
        ...
        /*  if (Input.GetKeyDown (DialogueInput) && !_isDialoguePlaying) {
          ...
          else if(Input.GetKeyDown(KeyCode.T) && !_isDialoguePlaying && !dialogueFinished)
          {
    ...
    private IEnumerator StartDialogue() {
		...
		while ((_currentDialogueIndex < length || !_isStringBeingRevealed) && !dialogueFinished) {
    ...
    private void hideDialogue()
    {
        ...
        //Avisar al player que la conversación ha acabado.
        _playerC.finishedDial();
    ...
    public void showDialogue(string objectName)
    {
        ...
        if (objectName == "Fernando")
        {
            readFile(FIRST_DIAL);
            
        }
        else if(objectName == "MariaTable")
        {
            readFile(SECOND_DIAL);
        }

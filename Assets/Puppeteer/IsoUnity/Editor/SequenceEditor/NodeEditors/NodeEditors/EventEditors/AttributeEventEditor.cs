    ...
    public class AttributeEventEditor : EventEditor
    {
        ...
        public void draw()
        {
            foreach (var parameterConfig in config.ParameterConfig)
            {
                ...
                if (parameterConfig.Value == typeof(object)) ge.setParameter(parameterConfig.Key, ParamEditor.LayoutEditorFor(parameterConfig.Key, ge.getParameter(parameterConfig.Key)));
            }
        }
